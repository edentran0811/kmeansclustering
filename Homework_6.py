...
st.title("KMeans Clustering Homework")
...
iteration = st.slider("Choose the number of iterations:", min_value = 1,
                           max_value = 100)

kmeans = KMeans(n_clusters = 5, max_iter=iteration, init=starting_points, n_init = 1)
kmeans.fit(X);
